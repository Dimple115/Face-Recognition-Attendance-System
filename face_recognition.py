...
class Face_recognition:
    def __init__(self,root):
        ...
        f_1lbl.place(x=0,y=55,width=650,height=700)
        ...
        f_1lbl.place(x=650,y=55,width=950,height=700)

        #=============button=======
        b1_1=Button(f_1lbl,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",18,"bold"),bg="green",fg="white")
        b1_1.place(x=300,y=620,width=200,height=40)

    #====================Attendence=====================
    def mark_attendence(self,i,r,n,d):
        with open("dimple.csv","r+",newline='\n') as f:
